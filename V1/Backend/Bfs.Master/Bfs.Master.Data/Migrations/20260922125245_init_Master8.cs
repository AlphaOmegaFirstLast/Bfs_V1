...
{
    /// <inheritdoc />
    public partial class init_Master8 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTemplate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EndTemplate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BfsManualCode", x => x.Id);
                });
