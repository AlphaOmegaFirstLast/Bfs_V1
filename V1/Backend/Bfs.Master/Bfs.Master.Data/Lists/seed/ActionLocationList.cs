...
namespace Bfs.Master.Data.Lists
{
    ...
    {
        public ActionLocationList(string connectionString)
        {
        ...
        public async Task<QueryResponse<ActionLocationListItem>> GetAsync(QueryRequest<ActionLocationListFilter> request)
        {
            ...
            using var db = new SqlConnection(_connectionString);
            {
                ...
                response.Items = (List<ActionLocationListItem>)items;
        ...
        {
            //base fields
            _fieldList.Add(new QueryField() { DbName = "ActionLocation.Id", QueryName = "Id", IsAggregare = false });
_fieldList.Add(new QueryField() { DbName = "ActionLocation.Name", QueryName = "Name", IsAggregare = false });
_fieldList.Add(new QueryField() { DbName = "ActionLocation.Notes", QueryName = "Notes", IsAggregare = false });
