...
_fieldList.Add(new QueryField() { DbName = "BfsSystem.IsMaster", QueryName = "IsMaster", IsAggregare = false });
...
_fieldList.Add(new QueryField() { DbName = "BfsSystem.Logo", QueryName = "Logo", IsAggregare = false });
