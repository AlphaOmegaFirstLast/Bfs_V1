...
{
    public class FilterTypeEntityConfiguration : IEntityTypeConfiguration<FilterTypeEntity>
    {
        public static readonly string TableNameCapital = "FilterType";

        public void Configure(EntityTypeBuilder<FilterTypeEntity> builder)
        {
