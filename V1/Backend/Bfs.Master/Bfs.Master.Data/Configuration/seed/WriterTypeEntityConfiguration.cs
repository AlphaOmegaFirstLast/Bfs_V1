...
{
    public class WriterTypeEntityConfiguration : IEntityTypeConfiguration<WriterTypeEntity>
    {
        public static readonly string TableNameCapital = "WriterType";

        public void Configure(EntityTypeBuilder<WriterTypeEntity> builder)
        {
