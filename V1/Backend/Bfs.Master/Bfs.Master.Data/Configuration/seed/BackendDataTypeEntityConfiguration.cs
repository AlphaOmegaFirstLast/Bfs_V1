...
{
    public class BackendDataTypeEntityConfiguration : IEntityTypeConfiguration<BackendDataTypeEntity>
    {
        public static readonly string TableNameCapital = "BackendDataType";

        public void Configure(EntityTypeBuilder<BackendDataTypeEntity> builder)
        {
