...
{
    public class DataTypeEntityConfiguration : IEntityTypeConfiguration<DataTypeEntity>
    {
        public static readonly string TableNameCapital = "DataType";

        public void Configure(EntityTypeBuilder<DataTypeEntity> builder)
        {
