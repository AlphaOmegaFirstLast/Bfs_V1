...
namespace Bfs.Master.Domain.Services
{
    public class BfsManualCodeService : IBfsManualCodeService
    {
        ...
        public BfsManualCodeService(IBfsManualCodeRepository repo, IBfsManualCodeList list)
        {
            _repo = repo;
            _list = list;
        }
...

        {
            ...
            //var message = new BfsManualCodeCreatedMessage
            //{
        ...
        public async Task<BfsManualCode?> UpdateAsync(BfsManualCode contract)
        {
            ...
            //var message = new BfsManualCodeUpdatedMessage
            //{
        ...
        public async Task DeleteAsync(long id)
        {
            ...
            //var message = new BfsManualCodeDeletedMessage
            //{
