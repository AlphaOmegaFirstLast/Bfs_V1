...
{
    public class UserRequestStatusEntityConfiguration : IEntityTypeConfiguration<UserRequestStatusEntity>
    {
        public static readonly string TableNameCapital = "athUserRequestStatus";

        public void Configure(EntityTypeBuilder<UserRequestStatusEntity> builder)
        {
