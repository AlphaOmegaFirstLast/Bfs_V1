...
public class ReportsController
{
    ...
    [HttpPost("DataType1Report")]
    [CustomAuthorize("method=q.dataType1")]
    public async Task<Results<Ok<QueryResponse<DataType1Item>>, BadRequest<ProblemDetails>>> DataType1Report([FromBody] QueryRequest<DataType1Filter> ReportRequest)
    {
        var result = await _reportsService.DataType1ReportAsync(ReportRequest).ConfigureAwait(false);
        return TypedResults.Ok(result);
    }
