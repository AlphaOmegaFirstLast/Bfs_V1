...
{
    public class TransferCostTypeEntityConfiguration : IEntityTypeConfiguration<TransferCostTypeEntity>
    {
        public static readonly string TableNameCapital = "stkxTransferCostType";

        public void Configure(EntityTypeBuilder<TransferCostTypeEntity> builder)
        {
