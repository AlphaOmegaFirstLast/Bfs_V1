...
{
    public class StockFieldTypeEntityConfiguration : IEntityTypeConfiguration<StockFieldTypeEntity>
    {
        public static readonly string TableNameCapital = "stkxStockFieldType";

        public void Configure(EntityTypeBuilder<StockFieldTypeEntity> builder)
        {
