...
{
    public class StockEntityTypeEntityConfiguration : IEntityTypeConfiguration<StockEntityTypeEntity>
    {
        public static readonly string TableNameCapital = "stkxStockEntityType";

        public void Configure(EntityTypeBuilder<StockEntityTypeEntity> builder)
        {
