...
{
    public class CouponStatusEntityConfiguration : IEntityTypeConfiguration<CouponStatusEntity>
    {
        public static readonly string TableNameCapital = "stkxCouponStatus";

        public void Configure(EntityTypeBuilder<CouponStatusEntity> builder)
        {
