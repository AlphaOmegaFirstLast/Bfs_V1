...
{
    public class SourceTypeEntityConfiguration : IEntityTypeConfiguration<SourceTypeEntity>
    {
        public static readonly string TableNameCapital = "stkxSourceType";

        public void Configure(EntityTypeBuilder<SourceTypeEntity> builder)
        {
