...
{
    public class ExpensesTypeEntityConfiguration : IEntityTypeConfiguration<ExpensesTypeEntity>
    {
        public static readonly string TableNameCapital = "stkxExpensesType";
