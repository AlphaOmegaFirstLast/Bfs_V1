...
{
    public class SsPortfolioBalanceEntityConfiguration : IEntityTypeConfiguration<SsPortfolioBalanceEntity>
    {
        public static readonly string TableNameCapital = "stkxSsPortfolioBalance";

        public void Configure(EntityTypeBuilder<SsPortfolioBalanceEntity> builder)
        {
...
//   builder.Property(e => e.Balance).HasMaxLength([FieldLength]).IsRequired();
