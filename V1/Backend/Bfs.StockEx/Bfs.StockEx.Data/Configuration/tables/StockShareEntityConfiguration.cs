...
{
    public class StockShareEntityConfiguration : IEntityTypeConfiguration<StockShareEntity>
    {
        public static readonly string TableNameCapital = "stkxStockShare";

        public void Configure(EntityTypeBuilder<StockShareEntity> builder)
        {
