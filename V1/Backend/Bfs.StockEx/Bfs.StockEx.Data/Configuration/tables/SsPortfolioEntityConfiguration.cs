...
{
    public class SsPortfolioEntityConfiguration : IEntityTypeConfiguration<SsPortfolioEntity>
    {
        public static readonly string TableNameCapital = "stkxSsPortfolio";

        public void Configure(EntityTypeBuilder<SsPortfolioEntity> builder)
        {
...
//   builder.Property(e => e.Interest).HasMaxLength([FieldLength]).IsRequired();
