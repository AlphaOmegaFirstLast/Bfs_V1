...
import { type ICalculationMethodWithLookup, type ICalculationMethodRequest, type ICalculationMethodFilter } from './calculation-method.shared';
...
export class CalculationMethodListComponent         
    ...
    extends BaseReportComponent<ICalculationMethodFilter, ICalculationMethodWithLookup> {
