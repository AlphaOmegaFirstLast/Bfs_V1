...
//---------------------- Component Specific ------------------------
import { type IEffectType, type IEffectTypeRequest, initEffectType, effectTypeUntypedFormGroup } from './effect-type.shared';
import { getEffectTypeActions,  initEffectTypeRequest } from './effect-type.shared';

@Component({
    selector: 'effect-type-form',
    imports: [

    CommonModule, NgIcon, NgbPopoverModule, NgbAlertModule, FormsModule, ReactiveFormsModule, NgbDropdownModule, NgbNavModule,RouterLink],
    standalone: true,
    templateUrl: './effect-type.form.component.html',
})
export class EffectTypeFormComponent extends BaseFormComponent<IEffectType > implements OnInit {

    override apiUrl =  '/EffectType/';
    override apiService: StockExService = inject(StockExService);
    override componentName: string = 'EffectType'.toLowerCase();  // used to grab its related custom field definitions
    ...
    constructor(activatedRoute: ActivatedRoute) {
       ...
       this.validationForm = this.formBuilder.group(effectTypeUntypedFormGroup(this.formBuilder)); // Use Angular Validation Controls
    ...
    //---------------------------------------------------------
    override initEntity(): IEffectType  {
