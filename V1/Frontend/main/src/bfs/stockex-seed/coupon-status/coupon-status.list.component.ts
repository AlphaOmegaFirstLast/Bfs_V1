...
import { type ICouponStatusWithLookup, type ICouponStatusRequest, type ICouponStatusFilter } from './coupon-status.shared';
...
export class CouponStatusListComponent         
    ...
    extends BaseReportComponent<ICouponStatusFilter, ICouponStatusWithLookup> {
