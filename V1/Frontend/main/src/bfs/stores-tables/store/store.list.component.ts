...
import { type IStoreWithLookup, type IStoreRequest, type IStoreFilter } from './store.shared';
import { getStoreActions,  initStoreRequest } from './store.shared';
...
export class StoreListComponent         
    ...
    extends BaseReportComponent<IStoreFilter, IStoreWithLookup> {
    override apiService: StoresService = inject(StoresService);
    override queryRequest = {} as IStoreRequest;
    override exportRequest = {} as IStoreRequest;
    override downloadFileName: string = "Stores";
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/str/store/add/0", displayText: "Add New Stores" };
        this.getApiUrl = '/Store/List';
        this.uploadApiUrl = '/Store/upload';

        this.filterComponent = StoreFilterComponent;
        this.queryRequest = initStoreRequest();
    }
    //---------------------------------------------------------
