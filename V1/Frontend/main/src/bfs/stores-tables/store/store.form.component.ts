...
//---------------------- Component Specific ------------------------
import { type IStore, type IStoreRequest, initStore, storeUntypedFormGroup } from './store.shared';
...
export class StoreFormComponent extends BaseFormComponent<IStore > implements OnInit {

    override apiUrl =  '/Store/';
    override apiService: StoresService = inject(StoresService);
    override componentName: string = 'Store'.toLowerCase();  // used to grab its related custom field definitions
