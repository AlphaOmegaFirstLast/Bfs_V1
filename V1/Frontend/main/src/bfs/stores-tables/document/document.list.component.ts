...
import { type IDocumentWithLookup, type IDocumentRequest, type IDocumentFilter } from './document.shared';
...
export class DocumentListComponent         
    ...
    extends BaseReportComponent<IDocumentFilter, IDocumentWithLookup> {
    override apiService: StoresService = inject(StoresService);
    override queryRequest = {} as IDocumentRequest;
    override exportRequest = {} as IDocumentRequest;
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/str/document/add/0", displayText: "Add New Transactions" };
        this.getApiUrl = '/Document/List';
        this.uploadApiUrl = '/Document/upload';

        this.filterComponent = DocumentFilterComponent;
        this.queryRequest = initDocumentRequest();
    }
    //---------------------------------------------------------
