...
import { type ITransactionWithLookup, type ITransactionRequest, type ITransactionFilter } from './transaction.shared';
...
export class TransactionListComponent         
    ...
    extends BaseReportComponent<ITransactionFilter, ITransactionWithLookup> {
    override apiService: StoresService = inject(StoresService);
    override queryRequest = {} as ITransactionRequest;
    override exportRequest = {} as ITransactionRequest;
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/str/transaction/add/0", displayText: "Add New Transactions" };
        this.getApiUrl = '/Transaction/List';
        this.uploadApiUrl = '/Transaction/upload';

        this.filterComponent = TransactionFilterComponent;
        this.queryRequest = initTransactionRequest();
    }
    //---------------------------------------------------------
    override render(record: IEntity, column: IColumns): any {
        ...
        switch (column.fieldName) {
            case 'storeId':
                return record['storeName']?.toString();
case 'operationId':
                return record['operationName']?.toString();
case 'productId':
