...
{links.push({
actionSource:'System', actionType:'FrontendLink', actionLocation:'ListHeader',recordId: 0, route:'/str/currency/add', displayText: 'Add New record'
});
}
if (component.accessService.isActionAllowed('currency', ''))
{links.push({
actionSource:'System', actionType:'FrontendLink', actionLocation:'ListRow',recordId: record['id'], route:'/str/currency/view', displayText: 'View...'
});
}
if (component.accessService.isActionAllowed('currency', ''))
{links.push({
actionSource:'System', actionType:'FrontendLink', actionLocation:'ListRow',recordId: record['id'], route:'/str/currency/edit', displayText: 'Edit...' 
});
}
if (component.accessService.isActionAllowed('currency', ''))
{links.push({
actionSource:'System', actionType:'FrontendLink', actionLocation:'ListRow',recordId: record['id'], route:'/str/currency/delete', displayText: 'Delete...' 
});
}
