...
//---------------------- Component Specific ------------------------
import { type IUnit, type IUnitRequest, initUnit, unitUntypedFormGroup } from './unit.shared';
...
export class UnitFormComponent extends BaseFormComponent<IUnit > implements OnInit {

    override apiUrl =  '/Unit/';
    override apiService: StoresService = inject(StoresService);
    override componentName: string = 'Unit'.toLowerCase();  // used to grab its related custom field definitions
