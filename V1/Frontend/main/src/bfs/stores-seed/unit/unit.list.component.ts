...
import { type IUnitWithLookup, type IUnitRequest, type IUnitFilter } from './unit.shared';
import { getUnitActions,  initUnitRequest } from './unit.shared';
...
export class UnitListComponent         
    ...
    extends BaseReportComponent<IUnitFilter, IUnitWithLookup> {
    override apiService: StoresService = inject(StoresService);
    override queryRequest = {} as IUnitRequest;
    override exportRequest = {} as IUnitRequest;
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/str/unit/add/0", displayText: "Add New Units" };
        this.getApiUrl = '/Unit/List';
        this.uploadApiUrl = '/Unit/upload';

        this.filterComponent = UnitFilterComponent;
        this.queryRequest = initUnitRequest();
    }
    //---------------------------------------------------------
