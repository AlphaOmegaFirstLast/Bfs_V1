...
import { type IStrUnitWithLookup, type IStrUnitRequest, type IStrUnitFilter } from './str-unit.shared';
import { getStrUnitActions,  initStrUnitRequest } from './str-unit.shared';
import { StrUnitFilterComponent } from './str-unit.filter.component'; 

@Component({
    selector: 'str-unit-list',     
...
export class StrUnitListComponent         

    extends BaseReportComponent<IStrUnitFilter, IStrUnitWithLookup> {
    override apiService: StoresService = inject(StoresService);
    override tokenService: TokenService = inject(TokenService);
    override queryRequest = {} as IStrUnitRequest;
    override exportRequest = {} as IStrUnitRequest;
    override downloadFileName: string = "Units";
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/str/str-unit/add/0", displayText: "Add New Units" };
        this.getApiUrl = '/StrUnit/List';
        this.uploadApiUrl = '/StrUnit/upload';

        this.filterComponent = StrUnitFilterComponent;
        this.queryRequest = initStrUnitRequest();
    }
    //---------------------------------------------------------
