...
import { type IStrCurrencyWithLookup, type IStrCurrencyRequest, type IStrCurrencyFilter } from './str-currency.shared';
import { getStrCurrencyActions,  initStrCurrencyRequest } from './str-currency.shared';
import { StrCurrencyFilterComponent } from './str-currency.filter.component'; 

@Component({
    selector: 'str-currency-list',     
...
export class StrCurrencyListComponent         

    extends BaseReportComponent<IStrCurrencyFilter, IStrCurrencyWithLookup> {
    override apiService: StoresService = inject(StoresService);
    override tokenService: TokenService = inject(TokenService);
    override queryRequest = {} as IStrCurrencyRequest;
    override exportRequest = {} as IStrCurrencyRequest;
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/str/str-currency/add/0", displayText: "Add New Currencies" };
        this.getApiUrl = '/StrCurrency/List';
        this.uploadApiUrl = '/StrCurrency/upload';

        this.filterComponent = StrCurrencyFilterComponent;
        this.queryRequest = initStrCurrencyRequest();
    }
    //---------------------------------------------------------
