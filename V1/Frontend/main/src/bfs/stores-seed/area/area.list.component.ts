...
import { type IAreaWithLookup, type IAreaRequest, type IAreaFilter } from './area.shared';
import { getAreaActions,  initAreaRequest } from './area.shared';
...
export class AreaListComponent         
    ...
    extends BaseReportComponent<IAreaFilter, IAreaWithLookup> {
    override apiService: StoresService = inject(StoresService);
    override queryRequest = {} as IAreaRequest;
    override exportRequest = {} as IAreaRequest;
    override downloadFileName: string = "Areas";
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/str/area/add/0", displayText: "Add New Areas" };
        this.getApiUrl = '/Area/List';
        this.uploadApiUrl = '/Area/upload';

        this.filterComponent = AreaFilterComponent;
        this.queryRequest = initAreaRequest();
    }
    //---------------------------------------------------------
    ...
    override getRecordLinks(record: IEntity): ViewLink[] {
        let actions = getAreaActions(this,record);
