...
//---------------------- Component Specific ------------------------
import { type IArea, type IAreaRequest, initArea, areaUntypedFormGroup } from './area.shared';
...
export class AreaFormComponent extends BaseFormComponent<IArea > implements OnInit {

    override apiUrl =  '/Area/';
    override apiService: StoresService = inject(StoresService);
    override componentName: string = 'Area'.toLowerCase();  // used to grab its related custom field definitions
    ...
    constructor(activatedRoute: ActivatedRoute) {
       ...
       this.validationForm = this.formBuilder.group(areaUntypedFormGroup(this.formBuilder)); // Use Angular Validation Controls
