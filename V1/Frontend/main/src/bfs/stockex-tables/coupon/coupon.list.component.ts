...
import { type ICouponWithLookup, type ICouponRequest, type ICouponFilter } from './coupon.shared';
import { getCouponActions,  initCouponRequest } from './coupon.shared';
...
export class CouponListComponent         
    ...
    extends BaseReportComponent<ICouponFilter, ICouponWithLookup> {
    override apiService: StockExService = inject(StockExService);
    override queryRequest = {} as ICouponRequest;
    override exportRequest = {} as ICouponRequest;
    override downloadFileName: string = "Coupons";
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/stkx/coupon/add/0", displayText: "Add New Coupons" };
        this.getApiUrl = '/Coupon/List';
        this.uploadApiUrl = '/Coupon/upload';

        this.filterComponent = CouponFilterComponent;
        this.queryRequest = initCouponRequest();
    }
    //---------------------------------------------------------
...
case 'couponStatusId':
    ...
    override getRecordLinks(record: IEntity): ViewLink[] {
        let actions = getCouponActions(this,record);
