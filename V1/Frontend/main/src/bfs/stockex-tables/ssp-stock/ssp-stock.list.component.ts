...
import { type ISspStockWithLookup, type ISspStockRequest, type ISspStockFilter } from './ssp-stock.shared';
...
export class SspStockListComponent         
    ...
    extends BaseReportComponent<ISspStockFilter, ISspStockWithLookup> {
