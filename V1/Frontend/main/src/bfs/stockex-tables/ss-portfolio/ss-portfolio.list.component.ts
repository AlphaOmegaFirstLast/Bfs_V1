...
import { type ISsPortfolioWithLookup, type ISsPortfolioRequest, type ISsPortfolioFilter } from './ss-portfolio.shared';
import { getSsPortfolioActions,  initSsPortfolioRequest } from './ss-portfolio.shared';
import { SsPortfolioFilterComponent } from './ss-portfolio.filter.component'; 

@Component({
    selector: 'ss-portfolio-list',     
...
export class SsPortfolioListComponent         

    extends BaseReportComponent<ISsPortfolioFilter, ISsPortfolioWithLookup> {
    override apiService: StockExService = inject(StockExService);
    override queryRequest = {} as ISsPortfolioRequest;
    override exportRequest = {} as ISsPortfolioRequest;
    override downloadFileName: string = "StockShare Portfolios";
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/stkx/ss-portfolio/add/0", displayText: "Add New StockShare Portfolios" };
        this.getApiUrl = '/SsPortfolio/List';
        this.uploadApiUrl = '/SsPortfolio/upload';

        this.filterComponent = SsPortfolioFilterComponent;
        this.queryRequest = initSsPortfolioRequest();
    }
    //---------------------------------------------------------
