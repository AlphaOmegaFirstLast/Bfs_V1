...
import { type ISspTransactionWithLookup, type ISspTransactionRequest, type ISspTransactionFilter } from './ssp-transaction.shared';
...
export class SspTransactionListComponent         
    ...
    extends BaseReportComponent<ISspTransactionFilter, ISspTransactionWithLookup> {
