...
import { type IInvestorWithLookup, type IInvestorRequest, type IInvestorFilter } from './investor.shared';
...
export class InvestorListComponent         
    ...
    extends BaseReportComponent<IInvestorFilter, IInvestorWithLookup> {
