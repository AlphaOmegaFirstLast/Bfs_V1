...
import { type IStockShareWithLookup, type IStockShareRequest, type IStockShareFilter } from './stock-share.shared';
...
export class StockShareListComponent         
    ...
    extends BaseReportComponent<IStockShareFilter, IStockShareWithLookup> {
