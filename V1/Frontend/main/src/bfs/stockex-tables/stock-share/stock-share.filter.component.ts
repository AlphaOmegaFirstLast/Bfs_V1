...
import { IStockShareFilter } from './stock-share.shared';

@Component({
    selector: 'app-stock-share-filter',
    imports: [FormsModule, CommonModule],
    templateUrl: './stock-share.filter.component.html'
    //styles: ``
})
export class StockShareFilterComponent implements OnInit {

    public result = {} as IStockShareFilter;
