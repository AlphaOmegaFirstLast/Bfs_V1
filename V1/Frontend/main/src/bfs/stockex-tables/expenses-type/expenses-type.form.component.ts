...
//---------------------- Component Specific ------------------------
import { type IExpensesType, type IExpensesTypeRequest, initExpensesType, expensesTypeUntypedFormGroup } from './expenses-type.shared';
...
export class ExpensesTypeFormComponent extends BaseFormComponent<IExpensesType > implements OnInit {

    override apiUrl =  '/ExpensesType/';
    override apiService: StockExService = inject(StockExService);
    override componentName: string = 'ExpensesType'.toLowerCase();  // used to grab its related custom field definitions
    ...
    constructor(activatedRoute: ActivatedRoute) {
       ...
       this.validationForm = this.formBuilder.group(expensesTypeUntypedFormGroup(this.formBuilder)); // Use Angular Validation Controls
    ...
    //---------------------------------------------------------
    override initEntity(): IExpensesType  {
        return initExpensesType ();
    }
    //---------------------------------------------------------
