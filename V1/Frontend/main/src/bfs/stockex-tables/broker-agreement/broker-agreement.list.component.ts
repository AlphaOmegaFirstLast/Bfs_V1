...
import { type IBrokerAgreementWithLookup, type IBrokerAgreementRequest, type IBrokerAgreementFilter } from './broker-agreement.shared';
...
export class BrokerAgreementListComponent         
    ...
    extends BaseReportComponent<IBrokerAgreementFilter, IBrokerAgreementWithLookup> {
