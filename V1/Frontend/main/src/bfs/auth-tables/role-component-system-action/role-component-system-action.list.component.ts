...
import { type IRoleComponentSystemActionWithLookup, type IRoleComponentSystemActionRequest, type IRoleComponentSystemActionFilter } from './role-component-system-action.shared';
import { getRoleComponentSystemActionActions,  initRoleComponentSystemActionRequest } from './role-component-system-action.shared';
import { RoleComponentSystemActionFilterComponent } from './role-component-system-action.filter.component'; 

@Component({
    selector: 'role-component-system-action-list',     
...
export class RoleComponentSystemActionListComponent         

    extends BaseReportComponent<IRoleComponentSystemActionFilter, IRoleComponentSystemActionWithLookup> {
    override apiService: AuthService = inject(AuthService);
    override queryRequest = {} as IRoleComponentSystemActionRequest;
    override exportRequest = {} as IRoleComponentSystemActionRequest;
    override downloadFileName: string = "Role - System Actions";
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/ath/role-component-system-action/add/0", displayText: "Add New Role - System Actions" };
        this.getApiUrl = '/RoleComponentSystemAction/List';
        this.uploadApiUrl = '/RoleComponentSystemAction/upload';
