...
import { type IAuthAppWithLookup, type IAuthAppRequest, type IAuthAppFilter } from './auth-app.shared';
import { getAuthAppActions,  initAuthAppRequest } from './auth-app.shared';
import { AuthAppFilterComponent } from './auth-app.filter.component'; 

@Component({
    selector: 'auth-app-list',     
...
export class AuthAppListComponent         

    extends BaseReportComponent<IAuthAppFilter, IAuthAppWithLookup> {
    override apiService: AuthService = inject(AuthService);
    override tokenService: TokenService = inject(TokenService);
    override queryRequest = {} as IAuthAppRequest;
    override exportRequest = {} as IAuthAppRequest;
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/bfs/auth-app/add/0", displayText: "Add New Applications" };
        this.getApiUrl = '/AuthApp/List';
        this.uploadApiUrl = '/AuthApp/upload';

        this.filterComponent = AuthAppFilterComponent;
        this.queryRequest = initAuthAppRequest();
    }
    //---------------------------------------------------------
