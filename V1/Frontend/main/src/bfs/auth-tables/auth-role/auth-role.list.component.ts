...
import { type IAuthRoleWithLookup, type IAuthRoleRequest, type IAuthRoleFilter } from './auth-role.shared';
import { getAuthRoleActions,  initAuthRoleRequest } from './auth-role.shared';
import { AuthRoleFilterComponent } from './auth-role.filter.component'; 
...
export class AuthRoleListComponent         

    extends BaseReportComponent<IAuthRoleFilter, IAuthRoleWithLookup> {
    override apiService: AuthService = inject(AuthService);
    override tokenService: TokenService = inject(TokenService);
    override queryRequest = {} as IAuthRoleRequest;
    override exportRequest = {} as IAuthRoleRequest;
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/bfs/auth-role/add/0", displayText: "Add New Roles" };
        this.getApiUrl = '/AuthRole/List';
        this.uploadApiUrl = '/AuthRole/upload';

        this.filterComponent = AuthRoleFilterComponent;
        this.queryRequest = initAuthRoleRequest();
    }
    //---------------------------------------------------------
