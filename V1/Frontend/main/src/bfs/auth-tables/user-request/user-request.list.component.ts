...
import { type IUserRequestWithLookup, type IUserRequestRequest, type IUserRequestFilter } from './user-request.shared';
...
export class UserRequestListComponent         
    ...
    extends BaseReportComponent<IUserRequestFilter, IUserRequestWithLookup> {
