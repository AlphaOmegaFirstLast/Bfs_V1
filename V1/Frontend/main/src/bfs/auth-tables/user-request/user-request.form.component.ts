...
//---------------------- Component Specific ------------------------
import { type IUserRequest, type IUserRequestRequest, initUserRequest, userRequestUntypedFormGroup } from './user-request.shared';
import { getUserRequestActions,  initUserRequestRequest } from './user-request.shared';
...
export class UserRequestFormComponent extends BaseFormComponent<IUserRequest > implements OnInit {

    override apiUrl =  '/UserRequest/';
    override apiService: AuthService = inject(AuthService);
    override componentName: string = 'UserRequest'.toLowerCase();  // used to grab its related custom field definitions
    ...
    //---------------------------------------------------------
    override initEntity(): IUserRequest  {
