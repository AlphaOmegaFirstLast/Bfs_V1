...
import { type IAggregateTypeWithLookup, type IAggregateTypeRequest, type IAggregateTypeFilter } from './aggregate-type.shared';
...
override getRecordLinks(record: IQueryColumn): ViewLink[] {
        let actions = getAggregateTypeActions(record);
