...
import { type IActionTypeWithLookup, type IActionTypeRequest, type IActionTypeFilter } from './action-type.shared';
...
export class ActionTypeListComponent         
 ...
 //   override list: IQueryColumn ; //IActionTypeWithLookup[] = [];
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/bfs/action-type/add/0", displayText: "Add New Action Types" };
...
override getRecordLinks(record: IQueryColumn): ViewLink[] {
        let actions = getActionTypeActions(record);
