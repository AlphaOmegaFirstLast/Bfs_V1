...
export class DataTypeFormComponent extends BaseFormComponent<IDataType > implements OnInit {

    override apiUrl =  '/DataType/';
    override apiService: InfrastructureService = inject(InfrastructureService);
    override componentName: string = 'DataType'.toLowerCase();  // used to grab its related custom field definitions
    ...
    constructor(activatedRoute: ActivatedRoute) {
        ...
        this.validationForm = this.formBuilder.group(dataTypeUntypedFormGroup(this.formBuilder)); // Use Angular Validation Controls
    }
    //---------------------------------------------------------
