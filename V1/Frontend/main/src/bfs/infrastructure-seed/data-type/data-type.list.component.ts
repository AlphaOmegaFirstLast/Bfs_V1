...
import { type IDataTypeWithLookup, type IDataTypeRequest, type IDataTypeFilter } from './data-type.shared';
import { getDataTypeActions,  initDataTypeRequest } from './data-type.shared';
import { DataTypeFilterComponent } from './data-type.filter.component'; 
...
export class DataTypeListComponent         
 ...
 //   override list: IQueryColumn ; //IDataTypeWithLookup[] = [];
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/bfs/data-type/add/0", displayText: "Add New Data Types" };
...
override getRecordLinks(record: IQueryColumn): ViewLink[] {
        let actions = getDataTypeActions(record);
