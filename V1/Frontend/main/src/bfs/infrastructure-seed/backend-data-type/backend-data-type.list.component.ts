...
import { type IBackendDataTypeWithLookup, type IBackendDataTypeRequest, type IBackendDataTypeFilter } from './backend-data-type.shared';
import { getBackendDataTypeActions,  initBackendDataTypeRequest } from './backend-data-type.shared';
...
export class BackendDataTypeListComponent         
 ...
 //   override list: IQueryColumn ; //IBackendDataTypeWithLookup[] = [];
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/bfs/backend-data-type/add/0", displayText: "Add New Backend Data Types" };
...
override getRecordLinks(record: IQueryColumn): ViewLink[] {
        let actions = getBackendDataTypeActions(record);
