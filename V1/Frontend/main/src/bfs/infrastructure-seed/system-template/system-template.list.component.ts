...
import { type ISystemTemplateWithLookup, type ISystemTemplateRequest, type ISystemTemplateFilter } from './system-template.shared';
import { getSystemTemplateActions,  initSystemTemplateRequest } from './system-template.shared';
import { SystemTemplateFilterComponent } from './system-template.filter.component'; 

@Component({
    selector: 'system-template-list',     
...
export class SystemTemplateListComponent         
 ...
 //   override list: IQueryColumn ; //ISystemTemplateWithLookup[] = [];
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/bfs/system-template/add/0", displayText: "Add New System Templates" };
...
override getRecordLinks(record: IQueryColumn): ViewLink[] {
        let actions = getSystemTemplateActions(record);
