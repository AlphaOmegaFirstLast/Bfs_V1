...
import { IReportCompareFilter } from './report-compare.shared';

@Component({
    selector: 'app-report-compare-report-filter',
    imports: [FormsModule, CommonModule],
    templateUrl: './report-compare.filter.component.html'
    //styles: ``
})
export class ReportCompareFilterComponent implements OnInit {

    public result = {} as IReportCompareFilter;
