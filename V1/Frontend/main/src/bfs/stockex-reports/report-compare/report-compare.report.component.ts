...
import { type IReportCompareWithLookup, type IReportCompareRequest, type IReportCompareFilter } from './report-compare.shared';
import { getReportCompareActions,  initReportCompareRequest } from './report-compare.shared';
import { ReportCompareFilterComponent } from './report-compare.filter.component'; 
...
export class ReportCompareComponent         

    extends BaseReportComponent<IReportCompareFilter, IReportCompareWithLookup> {
    override apiService: StockExService = inject(StockExService);
    override queryRequest = {} as IReportCompareRequest;
    override exportRequest = {} as IReportCompareRequest;
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.getApiUrl = '/reports/ReportCompare';

        this.filterComponent = ReportCompareFilterComponent;
        this.queryRequest = initReportCompareRequest();
    }
    //---------------------------------------------------------
...
case 'sumPrice':
   ...
   override getRecordLinks(record: IEntity): ViewLink[] {
        let actions = getReportCompareActions(this,record);
...
override getChart(records: IReportCompareWithLookup[]): EChartsOption {
        ...
        baseChart.yAxis = {
        data: reversedRecords.map(x => x['ssPortfolio_Name' as keyof IReportCompareWithLookup] ?? "unknown"),
