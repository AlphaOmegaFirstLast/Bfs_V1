...
import { type IStructureReportWithLookup, type IStructureReportRequest, type IStructureReportFilter, initStructureReportRequest } from './structure-report.shared';
import { StructureReportFilterComponent } from './structure-report.report.filter.component'; //ToDoReport .report

@Component({
selector: 'structure-report-report',
...
export class StructureReportReportComponent
    ...
    override list: IStructureReportWithLookup[] = [];
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.getApiUrl = '/reports/StructureReportReport';

        this.filterComponent = StructureReportFilterComponent;
        this.queryRequest = initStructureReportRequest();
    }
    //---------------------------------------------------------
    override render(record: IStructureReportWithLookup, column: IColumns): any {
        const value = record[column.fieldName as keyof IStructureReportWithLookup];
        switch (column.fieldName) {
            case 'componentDataTypeId':
    ...
    override getChart(records: IStructureReportWithLookup[]): EChartsOption {
        ...
        baseChart.yAxis = {
        data: reversedRecords.map(x => x['componentDisplayName' as keyof IStructureReportWithLookup] ?? "unknown"),
