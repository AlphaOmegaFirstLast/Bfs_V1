...
import { type IBfsComponentWithLookup, type IBfsComponentRequest, type IBfsComponentFilter } from './bfs-component.shared';
...
export class BfsComponentListComponent         
    ...
    extends BaseReportComponent<IBfsComponentFilter, IBfsComponentWithLookup> {
