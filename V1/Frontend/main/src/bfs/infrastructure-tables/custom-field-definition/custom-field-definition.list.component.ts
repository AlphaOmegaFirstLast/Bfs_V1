...
import { type ICustomFieldDefinitionWithLookup, type ICustomFieldDefinitionRequest, type ICustomFieldDefinitionFilter } from './custom-field-definition.shared';
import { getCustomFieldDefinitionActions,  initCustomFieldDefinitionRequest } from './custom-field-definition.shared';
...
export class CustomFieldDefinitionListComponent         
 ...
 //   override list: IQueryColumn ; //ICustomFieldDefinitionWithLookup[] = [];
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/bfs/custom-field-definition/add/0", displayText: "Add New Custom Field Definitions" };
...
override getRecordLinks(record: IQueryColumn): ViewLink[] {
        let actions = getCustomFieldDefinitionActions(record);
