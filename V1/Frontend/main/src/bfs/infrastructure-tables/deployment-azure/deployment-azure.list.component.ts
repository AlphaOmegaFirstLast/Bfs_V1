...
import { type IDeploymentAzureWithLookup, type IDeploymentAzureRequest, type IDeploymentAzureFilter } from './deployment-azure.shared';
import { getDeploymentAzureActions,  initDeploymentAzureRequest } from './deployment-azure.shared';
...
export class DeploymentAzureListComponent         
    ...
    extends BaseReportComponent<IDeploymentAzureFilter, IDeploymentAzureWithLookup> {
