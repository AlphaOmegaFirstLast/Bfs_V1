...
import { type IBfsClientSystemWithLookup, type IBfsClientSystemRequest, type IBfsClientSystemFilter } from './bfs-client-system.shared';
import { getBfsClientSystemActions,  initBfsClientSystemRequest } from './bfs-client-system.shared';
import { BfsClientSystemFilterComponent } from './bfs-client-system.filter.component'; 

@Component({
    selector: 'bfs-client-system-list',     
...
export class BfsClientSystemListComponent         

    extends BaseReportComponent<IBfsClientSystemFilter, IBfsClientSystemWithLookup> {
    ...
    override exportRequest = {} as IBfsClientSystemRequest;
    override downloadFileName: string = "Client - System";
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/bfs/bfs-client-system/add/0", displayText: "Add New Client - System" };
        this.getApiUrl = '/BfsClientSystem/List';
        this.uploadApiUrl = '/BfsClientSystem/upload';
