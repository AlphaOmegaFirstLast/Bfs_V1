...
import { type IBfsClientWithLookup, type IBfsClientRequest, type IBfsClientFilter } from './bfs-client.shared';
import { getBfsClientActions,  initBfsClientRequest } from './bfs-client.shared';
import { BfsClientFilterComponent } from './bfs-client.filter.component'; 

@Component({
    selector: 'bfs-client-list',     
...
export class BfsClientListComponent         

    extends BaseReportComponent<IBfsClientFilter, IBfsClientWithLookup> {
