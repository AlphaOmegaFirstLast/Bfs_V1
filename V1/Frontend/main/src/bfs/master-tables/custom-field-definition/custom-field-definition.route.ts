...
export const CustomFieldDefinition_ROUTES: Routes = [
    {
        path: 'mstr/custom-field-definition/list', 
        component: CustomFieldDefinitionListComponent,
        canActivate: [RouteGuardService],
        data: { role: ['admin'], api: ['master'], app: ['b.ofc'] } 
    },
    {
        path: 'mstr/custom-field-definition/list/:id', 
        component: CustomFieldDefinitionListComponent,
        canActivate: [RouteGuardService],
        data: { role: ['admin'], api: ['master'], app: ['b.ofc'] } 
    },
    {
        path: 'mstr/custom-field-definition/add/0', 
        component: CustomFieldDefinitionFormComponent,
        canActivate: [RouteGuardService],
        data: { role: ['admin'], api: ['master'], app: ['b.ofc'] } 
    },
    {
        path: 'mstr/custom-field-definition/view/:id', 
        component: CustomFieldDefinitionFormComponent,
        canActivate: [RouteGuardService],
        data: { role: ['admin', 'investor','broker'], api: ['master'], app: ['b.ofc'] } 
    },
    {
        path: 'mstr/custom-field-definition/edit/:id',
        component: CustomFieldDefinitionFormComponent,
        canActivate: [RouteGuardService],
        data: { role: ['admin'], api: ['master'], app: ['b.ofc'] } 
    },
    {
        path: 'mstr/custom-field-definition/delete/:id', 
        component: CustomFieldDefinitionFormComponent,
        canActivate: [RouteGuardService],
        data: { role: ['admin'], api: ['master'], app: ['b.ofc'] } 
    }
