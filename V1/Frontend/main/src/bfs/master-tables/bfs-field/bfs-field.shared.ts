...
export function bfsFieldUntypedFormGroup(formBuilder: FormBuilder): any {
    return {
        ...
        bfsComponentId: ['0', getFormControlValidation('{"IsRequired":true,"MinLength":null,"MaxLength":null,"MinValue":"","MaxValue":"","RegexPattern":"","AllowedValues":""}')],
        bfsComponentName: [''],
...
//---------------------------------------------------------
export function renderBfsField(record: IEntity, column: IQueryColumn): any {
