...
import { type IBfsComponentBusinessActionWithLookup, type IBfsComponentBusinessActionRequest, type IBfsComponentBusinessActionFilter } from './bfs-component-business-action.shared';
import { getBfsComponentBusinessActionActions,  initBfsComponentBusinessActionRequest } from './bfs-component-business-action.shared';
import { BfsComponentBusinessActionFilterComponent } from './bfs-component-business-action.filter.component'; 

@Component({
    selector: 'bfs-component-business-action-list',     
...
export class BfsComponentBusinessActionListComponent         

    extends BaseReportComponent<IBfsComponentBusinessActionFilter, IBfsComponentBusinessActionWithLookup> {
    ...
    constructor(modalService: NgbModal, router: Router, excelService: ExcelExportService, activatedRoute: ActivatedRoute) {
        ...
        this.addNewRecordLink = { route: "/mstr/bfs-component-business-action/add/0", displayText: "Add New Component - Business Actions" };
