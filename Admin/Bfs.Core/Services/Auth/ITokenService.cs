...
public interface ITokenService
{
    ...
    void SetRefreshTokenCookie(HttpResponse Response, string cookieName, long tenantId, string aspnetUserId, long systemId);
    ...
    Task<string> CreateIdentityTokenAsync(string masterConnection, string tenantId);
}