...
namespace Admin.App
{
    public class V1DbContext : DbContext
    {
        ...
        public DbSet<TableFieldEntity> TableField { get; set; }

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            var BestFitConnection = "Server=localhost;Database=BestFit_V2;Trusted_Connection=True;TrustServerCertificate=True";
